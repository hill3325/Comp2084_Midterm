...
namespace COMP2084_MidTerm_NET5.Controllers
{
    public class CandidatesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Candidate.Include(c => c.Job).OrderBy(lastname => lastname.LastName); //3a.1 Orders Candidates by last name on the candidates page.
